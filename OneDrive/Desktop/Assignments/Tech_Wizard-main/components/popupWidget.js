    ...
    return (
        <div>
            <Disclosure as="div" open={isOpen}>
                {({ open }) => (
                    <>
                        <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-primary-900 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-primary-800 focus:bg-indigo-600 ease">
                        ...
                        >
                            <Disclosure.Panel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                                <div className="flex flex-col items-center justify-center h-32 p-5 bg-primary-900">
                                ...
                                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                                    {!isSubmitSuccessful && (
                                        ...
                                        >
                                            <input
                                                type="hidden"
                                                value="ac506ea6-ef59-463a-adcd-03a22fd43ebf"
                                                {...register('apikey')}
                                            />
                                            <input
                                                type="hidden"
                                            ...
                                            <div className="mb-4">
                                                ...
                                                />
                                                {errors.name && (
                                                    <div className="mt-1 text-base text-red-400 invalid-feedback">
                                                        {errors.name.message}
                                                    </div>
                                                )}
                                            </div>
                                            ...
                                            <div className="mb-3">
                                                <button
                                                    type="submit"
                                                    className="w-full px-3 py-4 text-white bg-primary-900 rounded-md focus:bg-indigo-600 focus:outline-none"
                                                >
                                                    {isSubmitting ? (
                                                        <svg
