...
import heroImg from '../public/img/img-landingpng.png'
...
const Hero = () => {
    ...
    return (
        <>
            <Container className="flex flex-wrap  pt-36 md:pt-40">
                <div className="flex items-center w-full lg:w-2/3">
                    <div className="max-w-2xl mb-8">
                        <h1 className="text-3xl font-bold leading-snug tracking-tight text-black lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
                            Connecting shopper to your store
                        </h1>
                        <h2>
                            <p className="py-5 text-l leading-normal text-neutral-700 lg:text-xl xl:text-2xl">
                                Expand your reach and skyrocket your sales with
                                Briskk!
                            </p>
                        </h2>
                        {/* <p className="text-base leading-normal text-gray-500 lg:text-lg">
            Store Visit is Time Consuming, Unpredictable Experience and No Cross or Up-sell.
            </p> */}
                        <h3>
                            <p className="text-base leading-normal text-neutral-700 lg:text-lg">
                                <b
                                    onClick={toggleModal}
                                ...
                                today to transform your store into a digital
                                powerhouse. Effortlessly engage shoppers and
                                provide a seamless shopping journey that drives
                                loyalty and growth.
                            </p>
                        </h3>
                    </div>
                ...
                <div className="flex items-center justify-center w-full lg:w-1/3">
                    <div className="">
                        <Image
                            ...
                            alt="Engaged shoppers connecting with a store through Briskk's AI-driven platform"
                            loading="eager"
                            layout="intrinsic"
                            placeholder="blur"
                        />
